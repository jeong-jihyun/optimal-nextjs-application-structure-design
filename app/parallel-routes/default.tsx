...
export default function Default() {
    return (
      <Boundary label={['@children/default.tsx']} color="blue" size="small">
        <div className="prose-sm prose max-w-none">
          <h2 className="text-lg font-bold">디폴트(Default) UI</h2>
  
          <p>
            <code>@children</code> 내에 현재 <code>
          ...
          아래 2개 페이지 중 하나가 존재함
          <ul className="text-xs">
            <li><code>parallel-routes/default.js</code></li>
            <li><code>parallel-routes/@children/default.js</code></li>
          </ul>
